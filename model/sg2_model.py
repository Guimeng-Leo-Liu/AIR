...
from project.op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d, conv2d_gradfix
...
class ModulatedConv2d(nn.Module):
    def __init__(
        ...
        self.modulation = EqualLinear(style_dim, in_channel, bias_init=1) # fc layer
...
class Generator(nn.Module):
    def __init__(
        ...
        self.input = ConstantInput(self.channels[4]) # [batch, 512, 4, 4]
        self.conv1 = StyledConv(
            self.channels[4], self.channels[4], 3, style_dim, blur_kernel=blur_kernel
        ) # []
        self.to_rgb1 = ToRGB(self.channels[4], style_dim, upsample=False)

        self.log_size = int(math.log(size, 2)) # 1024->10, 512->9
    ...
    def forward_with_w(
            ...
            out = self.input(latent) # [batch, 512, 4, 4]
